...
class TestOptimalThreshold:
    ...
    def test_two_cluster_optimal_threshold(self):
        ...
        assert abs(rust_result.optimal_threshold - py_result['optimal_threshold']) < tolerance
...
class TestSymmetry:
    ...
    def test_upper_vs_lower_triangle(self):
        ...
        np.testing.assert_array_equal(result1.component_counts, result2.component_counts)
